...
public class MMWItemDagger extends Item {
  ...
  private final MMWEnumToolMaterial toolMaterial;

  public MMWItemDagger(int par1, MMWEnumToolMaterial par2EnumToolMaterial) {
    super(par1);
    this.toolMaterial = par2EnumToolMaterial;
    this.maxStackSize = 1;
    this.setMaxDamage(par2EnumToolMaterial.getMaxUses() >> 1);
    this.weaponDamage = 3 + par2EnumToolMaterial.getDamageVsEntity();
