...
public class MMWChunkProvider implements IChunkProvider
{
    /** RNG. */
    private Random rand;
    ...
    private MapGenBase caveGenerator = new MMWMapGenCaves();

    /** Holds Stronghold Generator */
    private MapGenStronghold strongholdGenerator = new MMWMapGenStronghold();

    /** Holds Village Generator */
    private MapGenVillage villageGenerator = new MMWMapGenVillage();

    /** Holds Mineshaft Generator */
    private MapGenMineshaft mineshaftGenerator = new MMWMapGenMineshaft();
    private MapGenScatteredFeature scatteredFeatureGenerator = new MMWMapGenScatteredFeature();

    /** Holds ravine generator */
    private MapGenBase ravineGenerator = new MMWMapGenRavine();
    ...
    public Chunk provideChunk(int par1, int par2)
    {
        ...
        {
            if (mod_MyWay.genMineshafts!=0) {
                this.mineshaftGenerator.generate(this, this.worldObj, par1, par2, var3);
            }
            if (mod_MyWay.genVillages!=0) {
                this.villageGenerator.generate(this, this.worldObj, par1, par2, var3);
            }
            if (mod_MyWay.genStrongholds!=0) {
                this.strongholdGenerator.generate(this, this.worldObj, par1, par2, var3);
            }
            if (mod_MyWay.genScatteredFeatures!=0) {
    ...
    public void populate(IChunkProvider par1IChunkProvider, int par2, int par3)
    {
        ...
        if (!var11 && (mod_MyWay.genLakes!=0) && (this.rand.nextInt((mod_MyWay.genLakes==2) ? 4 : ((mod_MyWay.genLakes==3) ? 2 : 8)) == 0))
        {
        ...
        if (!var11 && (mod_MyWay.genLavaLakes!=0) && (this.rand.nextInt((mod_MyWay.genLavaLakes==2) ? 8 : ((mod_MyWay.genLavaLakes==3) ? 4 : 16)) == 0))
        {
            var12 = var4 + this.rand.nextInt(16) + 8;
        ...
        if (mod_MyWay.genDungeons!=0) {
          for (var12 = 0; var12 < ((mod_MyWay.genDungeons==2) ? 8 : (mod_MyWay.genDungeons==3) ? 16 : 4); ++var12)
          {
